...
struct Human36 : public testing::Test
{
    ...
    void generate()
    {
        ...
        body_id_emulated[BodyPelvis] = model_emulated->AddBody(0, Xtrans(Vector3d(0., 0., 0.)), free_flyer, pelvis_body, "pelvis","rootJoint");

        // right leg
        body_id_emulated[BodyThighRight] = model_emulated->AddBody(body_id_emulated[BodyPelvis], Xtrans(Vector3d(0., -0.0872, 0.)), rot_yxz_emulated, thigh_body, "thigh_r","hip_joint_r");
        body_id_emulated[BodyShankRight] = model_emulated->AppendBody(Xtrans(Vector3d(0., 0., -SegmentLengths[SegmentThigh])), rot_y, shank_body, "shank_r","knee_joint_r");
        body_id_emulated[BodyFootRight] = model_emulated->AppendBody(Xtrans(Vector3d(0., 0., -SegmentLengths[SegmentShank])), rot_yz, foot_body, "foot_r","ankle_joint_r");

        // left leg
        body_id_emulated[BodyThighLeft] = model_emulated->AddBody(body_id_emulated[BodyPelvis], Xtrans(Vector3d(0., 0.0872, 0.)), rot_yxz_emulated, thigh_body, "thigh_l","hip_joint_l");
        body_id_emulated[BodyShankLeft] = model_emulated->AppendBody(Xtrans(Vector3d(0., 0., -SegmentLengths[SegmentThigh])), rot_y, shank_body, "shank_l","knee_joint_l");
        body_id_emulated[BodyFootLeft] = model_emulated->AppendBody(Xtrans(Vector3d(0., 0., -SegmentLengths[SegmentShank])), rot_yz, foot_body, "foot_l","ankle_joint_l");

        // trunk
        body_id_emulated[BodyMiddleTrunk] = model_emulated->AddBody(body_id_emulated[BodyPelvis], Xtrans(Vector3d(0., 0., SegmentLengths[SegmentPelvis])), rot_yxz_emulated, middle_trunk_body, "middletrunk","torso_joint");
        ...
        // right arm
        body_id_emulated[BodyUpperArmRight] = model_emulated->AddBody(body_id_emulated[BodyUpperTrunk], Xtrans(Vector3d(0., -0.1900, SegmentLengths[SegmentUpperTrunk])), rot_yxz_emulated, upperarm_body, "upperarm_r","shoulder_joint_r");
        body_id_emulated[BodyLowerArmRight] = model_emulated->AppendBody(Xtrans(Vector3d(0., 0., -SegmentLengths[SegmentUpperArm])), rot_y, lowerarm_body, "lowerarm_r","elbow_joint_r");
        body_id_emulated[BodyHandRight] = model_emulated->AppendBody(Xtrans(Vector3d(0., 0., -SegmentLengths[SegmentLowerArm])), rot_yz, hand_body, "hand_r","wrist_joint_r");

        // left arm
        body_id_emulated[BodyUpperArmLeft] = model_emulated->AddBody(body_id_emulated[BodyUpperTrunk], Xtrans(Vector3d(0., 0.1900, SegmentLengths[SegmentUpperTrunk])), rot_yxz_emulated, upperarm_body, "upperarm_l","shoulder_joint_l");
        body_id_emulated[BodyLowerArmLeft] = model_emulated->AppendBody(Xtrans(Vector3d(0., 0., -SegmentLengths[SegmentUpperArm])), rot_y, lowerarm_body, "lowerarm_l","elbow_joint_l");
        body_id_emulated[BodyHandLeft] = model_emulated->AppendBody(Xtrans(Vector3d(0., 0., -SegmentLengths[SegmentLowerArm])), rot_yz, hand_body, "hand_l","wrist_joint_l");

        // head
        body_id_emulated[BodyHead] = model_emulated->AddBody(body_id_emulated[BodyUpperTrunk], Xtrans(Vector3d(0., 0.1900, SegmentLengths[SegmentUpperTrunk])), rot_yxz_emulated, upperarm_body, "head","neck_joint");
        ...
        // right leg
        body_id_3dof[BodyThighRight] = model_3dof->AddBody(body_id_3dof[BodyPelvis], Xtrans(Vector3d(0., -0.0872, 0.)), rot_yxz_3dof, thigh_body, "thigh_r","hip_joint_r");
        body_id_3dof[BodyShankRight] = model_3dof->AppendBody(Xtrans(Vector3d(0., 0., -SegmentLengths[SegmentThigh])), rot_y, shank_body, "shank_r","knee_joint_r");
        body_id_3dof[BodyFootRight] = model_3dof->AppendBody(Xtrans(Vector3d(0., 0., -SegmentLengths[SegmentShank])), rot_yz, foot_body, "foot_r","ankle_joint_r");

        // left leg
        body_id_3dof[BodyThighLeft] = model_3dof->AddBody(body_id_3dof[BodyPelvis], Xtrans(Vector3d(0., 0.0872, 0.)), rot_yxz_3dof, thigh_body, "thigh_l","hip_joint_l");
        body_id_3dof[BodyShankLeft] = model_3dof->AppendBody(Xtrans(Vector3d(0., 0., -SegmentLengths[SegmentThigh])), rot_y, shank_body, "shank_l","knee_joint_l");
        body_id_3dof[BodyFootLeft] = model_3dof->AppendBody(Xtrans(Vector3d(0., 0., -SegmentLengths[SegmentShank])), rot_yz, foot_body, "foot_l","ankle_joint_l");

        // trunk
        body_id_3dof[BodyMiddleTrunk] = model_3dof->AddBody(body_id_3dof[BodyPelvis], Xtrans(Vector3d(0., 0., SegmentLengths[SegmentPelvis])), rot_yxz_3dof, middle_trunk_body, "middletrunk","torso_joint");
        ...
        // right arm
        body_id_3dof[BodyUpperArmRight] = model_3dof->AddBody(body_id_3dof[BodyUpperTrunk], Xtrans(Vector3d(0., -0.1900, SegmentLengths[SegmentUpperTrunk])), rot_yxz_3dof, upperarm_body, "upperarm_r","shoulder_joint_r");
        body_id_3dof[BodyLowerArmRight] = model_3dof->AppendBody(Xtrans(Vector3d(0., 0., -SegmentLengths[SegmentUpperArm])), rot_y, lowerarm_body, "lowerarm_r","elbow_joint_r");
        body_id_3dof[BodyHandRight] = model_3dof->AppendBody(Xtrans(Vector3d(0., 0., -SegmentLengths[SegmentLowerArm])), rot_yz, hand_body, "hand_r","wrist_joint_r");

        // left arm
        body_id_3dof[BodyUpperArmLeft] = model_3dof->AddBody(body_id_3dof[BodyUpperTrunk], Xtrans(Vector3d(0., 0.1900, SegmentLengths[SegmentUpperTrunk])), rot_yxz_3dof, upperarm_body, "upperarm_l","shoulder_joint_l");
        body_id_3dof[BodyLowerArmLeft] = model_3dof->AppendBody(Xtrans(Vector3d(0., 0., -SegmentLengths[SegmentUpperArm])), rot_y, lowerarm_body, "lowerarm_l","elbow_joint_l");
        body_id_3dof[BodyHandLeft] = model_3dof->AppendBody(Xtrans(Vector3d(0., 0., -SegmentLengths[SegmentLowerArm])), rot_yz, hand_body, "hand_l","wrist_joint_l");

        // head
        body_id_3dof[BodyHead] = model_3dof->AddBody(body_id_3dof[BodyUpperTrunk], Xtrans(Vector3d(0., 0.1900, SegmentLengths[SegmentUpperTrunk])), rot_yxz_3dof, upperarm_body, "head","neck_joint");
    }
