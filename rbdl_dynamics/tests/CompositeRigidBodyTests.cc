...
TEST_F(CompositeRigidBodyFixture, TestCompositeRigidBodyForwardDynamicsFloatingBase)
{
    ...
    EXPECT_TRUE(unit_test_utils::checkArraysEpsilonClose(QDDot.data(), QDDot_crba.data(), QDDot.size(), TEST_PREC));
}
...
//
//  unit_test_utils::checkArraysEpsilonClose (QDDot.data(), QDDot_crba.data(), QDDot.size(), TEST_PREC);
//}
//
...
//
//  unit_test_utils::checkArraysEpsilonClose (H_crba.data(), H_id.data(), model->dof_count * model->dof_count, TEST_PREC);
//}
//
...
//      );
//
//  unit_test_utils::checkArraysEpsilonClose (H_ref.data(), H.data(), 9, TEST_PREC);
//}
