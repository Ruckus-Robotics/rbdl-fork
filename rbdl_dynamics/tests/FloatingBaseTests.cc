...
struct FloatingBaseFixture : public testing::Test
{
    FloatingBaseFixture()
    {
...
TEST_F (FloatingBaseFixture, TestCalcPointTransformation)
{
    ...
    EXPECT_TRUE(unit_test_utils::checkArraysEpsilonClose(Vector3d(0., -1., 0.).data(), test_point.data(), 3, TEST_PREC));
}
...
TEST_F(FloatingBaseFixture, TestCalcPointVelocityCustom)
{
    ...
    EXPECT_TRUE(unit_test_utils::checkArraysEpsilonClose(point_base_velocity_reference.data(), point_base_velocity.data(), 3, TEST_PREC));
}
...
TEST_F(FloatingBaseFixture, TestCalcPointAccelerationNoQDDot)
{
    ...
    EXPECT_TRUE(unit_test_utils::checkArraysEpsilonClose(humans_point_position.data(), point_world_position.data(), 3, TEST_PREC));
    EXPECT_TRUE(unit_test_utils::checkArraysEpsilonClose(humans_point_velocity.data(), point_world_velocity.data(), 3, TEST_PREC));
    EXPECT_TRUE(unit_test_utils::checkArraysEpsilonClose(humans_point_acceleration.data(), point_world_acceleration.data(), 3, TEST_PREC));
}
