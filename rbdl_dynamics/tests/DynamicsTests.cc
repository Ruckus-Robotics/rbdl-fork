...
struct DynamicsFixture : public testing::Test
{
    DynamicsFixture()
    {
...
)
{
    ...
    model->AddBody(0,
                   Xtrans(Vector3d(0., 0., 0.)), joint, body
    );
...
)
{
    ...
    model->AddBody(0,
                   Xtrans(Vector3d(0., 0., 0.)), joint_a, body_a
    );
    ...
    model->AddBody(1,
                   Xtrans(Vector3d(1., 0., 0.)), joint_b, body_b
    );
...
)
{
    ...
    model->AddBody(2,
                   Xtrans(Vector3d(1., 0., 0.)), joint_c, body_c
    );
...
)
{
    ...
    model->AddBody(1,
                   Xtrans(Vector3d(1., 0., 0.)), joint_b1, body_b1
    );
    ...
    model->AddBody(2,
                   Xtrans(Vector3d(0., 1., 0.)), joint_c1, body_c1
    );
    ...
    model->AddBody(1,
                   Xtrans(Vector3d(-0.5, 0., 0.)), joint_b2, body_b2
    );
    ...
    model->AddBody(4,
                   Xtrans(Vector3d(0., -0.5, 0.)), joint_c2, body_c2
    );
...
TEST_F(DynamicsFixture, TestForwardDynamicsLagrangian)
{
    Model model;
    ...
    EXPECT_TRUE(unit_test_utils::checkArraysEpsilonClose(QDDot_aba.data(), QDDot_lagrangian.data(), QDDot_aba.size(), TEST_PREC));
}
 ...
 * it here.
 */
TEST_F(DynamicsFixture, TestForwardDynamics3DoFModel)
{
    Model model;
    ...
    EXPECT_TRUE(unit_test_utils::checkArraysEpsilonClose(QDDot_ref.data(), QDDot.data(), QDDot.size(), TEST_PREC));
}
 ...
 */
TEST_F(DynamicsFixture, TestForwardDynamics3DoFModelLagrangian)
{
    Model model;
    ...
    EXPECT_TRUE(unit_test_utils::checkArraysEpsilonClose(QDDot_ab.data(), QDDot_lagrangian.data(), QDDot_ab.size(), TEST_PREC));
}
 ...
 */
TEST_F(DynamicsFixture, TestForwardDynamicsTwoLegModelLagrangian)
{
    Model *model = NULL;
    ...
    EXPECT_TRUE(unit_test_utils::checkArraysEpsilonClose(QDDotABA.data(), QDDot.data(), QDDotABA.size(), TEST_PREC));
...
)
{
    ...
    EXPECT_TRUE(unit_test_utils::checkArraysEpsilonClose(QDDot_fixed_emulate
                              .
...
)
{
    ...
    EXPECT_TRUE(unit_test_utils::checkArraysEpsilonClose(Tau_2dof
                              .
...
)
{
    ...
    EXPECT_TRUE(unit_test_utils::checkArraysEq(QDDot
                              .
...
)
{
    ...
    EXPECT_TRUE(unit_test_utils::checkArraysEpsilonClose(qddot_solve_llt
                              .
...
)
{
            ...
            j < 1; j++)
    {
        ...
        EXPECT_TRUE(unit_test_utils::checkArraysEpsilonClose(qddot_solve_llt.data(), qddot_minv.data(), model->dof_count, TEST_PREC));
    }
}
